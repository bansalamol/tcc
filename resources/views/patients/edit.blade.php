                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg px-4 py-4">
                    ...
                    <form method="POST" action="{{ route('patients.update', $patient ) }}">
                        ...
                        <div>
                            ...
                            <x-input id="birth_date" class="block mt-1 w-full" type="text" name="birth_date" :value="$patient->birth_date" required autofocus autocomplete="birth_date" />
                        </div>
                        
                        <div>
                            <x-label for="age" value="{{ __('Age') }}" />
                            <x-input id="age" class="block mt-1 w-full" type="text" name="age" :value="$patient->age" required autofocus autocomplete="age" />
                        </div>
